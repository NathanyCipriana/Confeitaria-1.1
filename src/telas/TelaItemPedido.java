...
public class TelaItemPedido extends javax.swing.JFrame {
    ...
    public void carregarItensPedido() {
        try {
            ...
            List<ItemPedido> itens = itemDao.getItensPorPedido(0); // Ou passar um ID específico
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaItemPedido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
